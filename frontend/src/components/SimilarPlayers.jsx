...
import { ValueIcon, WageIcon } from "./icons/PlaceholderIcons";
import PlayerAvatar from "./PlayerAvatar";
import ClubLogo from "./ClubLogo";
import LeagueLogo from "./LeagueLogo";

const EMPTY_IMAGES = { clubs: {}, leagues: {}, players: {} };

function SimilarPlayers({ players, images = EMPTY_IMAGES }) {
    ...
    <section className="results-section">
      ...
      <div className="players-grid">
        {players.map((player, index) => {
          ...
          const displayName =
            player.long_name || player.short_name || "Unknown Player";
            ...
            >
              ...
              <div className="player-details">
                ...
                <div className="player-name-row">
                  <PlayerAvatar
                    url={images.players[displayName]}
                    name={displayName}
                    size={56}
                  />
